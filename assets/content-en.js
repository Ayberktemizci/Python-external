/* ============================================================================
   Kodland Python Tutor Training — CONTENT (English, EXTERNAL edition)
   External/candidate-facing version: contains no internal lesson recordings,
   no QA rubric material and no student data. Do not copy internal-only
   modules into this file.
   dst.formUrl points at the EXTERNAL candidate submission form.
   ============================================================================ */
window.CONTENT = {
code: 'en',
htmlLang: 'en',
...
dst: {
  formUrl: 'https://docs.google.com/forms/d/e/1FAIpQLSdCi0tyMOaNSEMHSgvH1MIwZQ9yLmWz06GZyn0bG_nCaSS33w/viewform',
  placeholderNote: 'The submission form will be shared with you shortly — check back here or contact your recruiter.',
  ...
  },
  {
    ...
    sections:[
      ...
      {t:'🎯 Putting it into practice', cards:[
        ...
        {type:'tip', txt:'Keep a mental (or literal) checklist of the eight phases for your first lessons. After a few weeks the rhythm becomes automatic. This is the final module — once you pass its quiz, the Digital Skill Test unlocks.'}
      ]}
    ],
    quiz:[
